      ...
      <div className="flex justify-between items-center mb-4">
        ...
        {hasActiveFilters && (
          <button
            ...
            className="text-sm text-[#FC6D26] hover:text-[#E45A1F] font-semibold underline"
          >
            ✕ Clear All
          </button>
        )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FC6D26]"
          >
        ...
        <div className="flex items-end">
          <div className="w-full bg-orange-50 border border-orange-200 rounded-lg p-3 text-center">
            ...
            <p className="text-xl font-bold text-[#FC6D26]">{filteredCount}/{findingsCount}</p>
          </div>
        </div>
      </div>
    </div>
